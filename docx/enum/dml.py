...
class MSO_COLOR_TYPE(Enumeration):
    ...
    __members__ = (
        ...
        EnumMember("THEME", 2, "Color is one of the preset theme colors."),
        EnumMember(
...
class MSO_THEME_COLOR_INDEX(XmlEnumeration):
    ...
    __members__ = (
        ...
        XmlMappedEnumMember("DARK_1", 1, "dark1", "Specifies the Dark 1 theme color."),
        XmlMappedEnumMember("DARK_2", 3, "dark2", "Specifies the Dark 2 theme color."),
        XmlMappedEnumMember(
            "FOLLOWED_HYPERLINK",
            12,
            "followedHyperlink",
        ...
        XmlMappedEnumMember("TEXT_1", 13, "text1", "Specifies the Text 1 theme color."),
        XmlMappedEnumMember("TEXT_2", 15, "text2", "Specifies the Text 2 theme color."),
    )
